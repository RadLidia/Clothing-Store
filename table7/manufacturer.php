...
require_once("../table7/php/operationm.php");
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <div class="container text-center">
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50">
                <div class="pt-2">
                    <?php inputElement("<i class=\"fas fa-id-badge\"></i>", "Id","id_manufacturer", setID());?>
                </div>
                <div class="row pt-2">
                    <div class="col">
                        <?php inputElement("<i class=\"fas fa-user\"></i>", "Company name","company_name", "");?>
                    </div>
                    <div class="col">
                        <?php inputElement("<i class=\"fas fa-phone\"></i>", "Company phone","phone", "");?>
                    </div>
                </div>
                <div class="d-flex justify-content-center">
        ...
        <div class="d-flex table-data">
            <table class="table table-striped table-dark" style= "margin: 1em 10em">
                ...
                <tr>
                    <td data-id="<?php echo $row['id_manufacturer'];?>"><?php echo $row['id_manufacturer'];?></td>
                    <td data-id="<?php echo $row['id_manufacturer'];?>"><?php echo $row['company_name'];?></td>
                    <td data-id="<?php echo $row['id_manufacturer'];?>"><?php echo $row['phone'];?></td>
                    <td><i class="fas fa-edit btnedit" data-id="<?php echo $row['id_manufacturer'];?>"></i></td>
                </tr>
                <?php
                }
                }
...
<script src="../table7/php/main.js"></script>
</body>
</html>