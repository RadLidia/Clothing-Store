...
require_once("../table9/php/operationsp.php");
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <div class="container text-center">
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50">
                <div class="pt-2">
                    <?php inputElement("<i class=\"fas fa-id-badge\"></i>", "Id","id_sp", setID());?>
                </div>
                <div class="row pt-2">
                    <div class="col">
                        <?php inputElement("<i class=\"fas fa-user\"></i>", "Store id","store_id", "");?>
                    </div>
                    <div class="col">
                        <?php inputElement("<i class=\"fas fa-phone\"></i>", "Product id","product_id", "");?>
                    </div>
                </div>
                <div class="d-flex justify-content-center">
        ...
        <div class="d-flex table-data">
            <table class="table table-striped table-dark" style= "margin: 1em 10em">
                ...
                <tr>
                    <td data-id="<?php echo $row['id_sp'];?>"><?php echo $row['id_sp'];?></td>
                    <td data-id="<?php echo $row['id_sp'];?>"><?php echo $row['store_id'];?></td>
                    <td data-id="<?php echo $row['id_sp'];?>"><?php echo $row['product_id'];?></td>
                    <td><i class="fas fa-edit btnedit" data-id="<?php echo $row['id_sp'];?>"></i></td>
                </tr>
                <?php
                }
                }
