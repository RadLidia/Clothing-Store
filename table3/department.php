...
require_once("../table3/php/operationd.php");
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <div class="container text-center">
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50">
                <div class="pt-2">
                    <?php inputElement("<i class=\"fas fa-id-badge\"></i>", "Id","id_department", setID());?>
                </div>
                <div class="pt-2">
                    <?php inputElement("<i class=\"fas fa-user\"></i>", "Department name","name", "");?>
                </div>
                <div class="pt-2">
                    <?php inputElement("<i class=\"fas fa-users\"></i>", "Nr. of employees","nr_of_employees", "");?>
                </div>
                <div class="d-flex justify-content-center">
        ...
        <div class="d-flex table-data">
            <table class="table table-striped table-dark" style= "margin: 1em 10em">
                ...
                <tr>
                    <td data-id="<?php echo $row['id_department'];?>"><?php echo $row['id_department'];?></td>
                    <td data-id="<?php echo $row['id_department'];?>"><?php echo $row['name'];?></td>
                    <td data-id="<?php echo $row['id_department'];?>"><?php echo $row['nr_of_employees'];?></td>
                    <td><i class="fas fa-edit btnedit" data-id="<?php echo $row['id_department'];?>"></i></td>
                </tr>
                <?php
                }
                }
...
<script src="../table3/php/main.js"></script>
</body>
</html>