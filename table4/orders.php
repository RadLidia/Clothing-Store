...
require_once("../table4/php/operationo.php");
?>
<!doctype html>
<html lang="en">
<head>
    ...
    <div class="container text-center">
        ...
        <div class="d-flex justify-content-center">
            <form action="" method="post" class="w-50">
                <div class="pt-2">
                    <?php inputElement("<i class=\"fas fa-id-badge\"></i>", "Id","id_order", setID());?>
                </div>
                <div class="pt-2">
                    <?php inputElement("<i class=\"far fa-calendar-alt\"></i>", "Shipping date","shipping_date", "");?>
                </div>
                <div class="row pt-2">
                    <div class="col">
                        <?php inputElement("<i class=\"fas fa-user-alt\"></i>", "Customer id","customer_id", "");?>
                    </div>
                    <div class="col">
                        <?php inputElement("<i class=\"fas fa-user-alt\"></i>", "Employee id","employee_id", "");?>
                    </div>
                    <div class="col">
                        <?php inputElement("<i class=\"fas fa-user-alt\"></i>", "Shipper id","shipper_id", "");?>
                    </div>
                </div>
                <div class="d-flex justify-content-center">
        ...
        <div class="d-flex table-data">
            <table class="table table-striped table-dark" style= "margin: 1em 10em">
                ...
                <tr>
                    <td data-id="<?php echo $row['id_order'];?>"><?php echo $row['id_order'];?></td>
                    <td data-id="<?php echo $row['id_order'];?>"><?php echo $row['shipping_date'];?></td>
                    <td data-id="<?php echo $row['id_order'];?>"><?php echo $row['customer_id'];?></td>
                    <td data-id="<?php echo $row['id_order'];?>"><?php echo $row['employee_id'];?></td>
                    <td data-id="<?php echo $row['id_order'];?>"><?php echo $row['shipper_id'];?></td>
                    <td><i class="fas fa-edit btnedit" data-id="<?php echo $row['id_order'];?>"></i></td>
                </tr>
                <?php
                }
                }
...
<script src="../table4/php/main.js"></script>
</body>
</html>